...
import br.com.sgpf.app.financeiro.domain.valueobject.enums.Moeda;
...
public class Conta extends AbstractUUIDEntity {
	...
	@NotNull(message = "{conta.moeda.not_null}")
	@Column(name = "CONT_IN_MOEDA", nullable = false, length = 3, columnDefinition = "CHAR")
